...
public class RichEditor extends WebView {
    ...
    private String mDate; // 笔记创建时间

    // 设置笔记标题内容
    public void setTitle(String titleString) {
        mTitle = titleString;
        exec("javascript:RE.setTitle('" + mTitle + "');");
    }
    ...
    public void TitleChange() {
        loadUrl("javascript:(" +
                ...
                "   var TitleContent = Title.innerText;" +
                "   window.TextListener.ToGetTitle(TitleContent);" +
                ");");
    }
    ...
    public void load(String trigger) {
