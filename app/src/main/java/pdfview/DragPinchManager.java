...
import pdfview.util.DragPinchListener;
import pdfview.util.DragPinchListener.OnDoubleTapListener;
import pdfview.util.DragPinchListener.OnDragListener;
import pdfview.util.DragPinchListener.OnPinchListener;

import static pdfview.util.Constants.Pinch.MAXIMUM_ZOOM;
import static pdfview.util.Constants.Pinch.MINIMUM_ZOOM;
import static pdfview.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_DISTANCE;
import static pdfview.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_TIME;
