...
import vudroid.core.events.ZoomListener;
import vudroid.core.models.CurrentPageModel;
import vudroid.core.models.DecodingProgressModel;
import vudroid.core.models.ZoomModel;
import vudroid.core.multitouch.MultiTouchZoom;
...
public class DocumentView extends View implements ZoomListener {
    ...
    private void initMultiTouchZoomIfAvailable(ZoomModel zoomModel) {
        try {
            multiTouchZoom = (MultiTouchZoom) Class.forName("org.org.vudroid.core.multitouch.MultiTouchZoomImpl").getConstructor(ZoomModel.class).newInstance(zoomModel);
        } catch (Exception e) {
